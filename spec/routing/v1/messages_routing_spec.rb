...
RSpec.describe V1::MessagesController, type: :routing do
  describe 'routing' do
    ...
    it '!routes to #update via PUT' do
      expect(put: '/v1/messages/1').not_to route_to('v1/messages#update', id: '1')
    end

    it '!routes to #update via PATCH' do
      expect(patch: '/v1/messages/1').not_to route_to('v1/messages#update', id: '1')
    end

    it '!routes to #destroy' do
      expect(delete: '/v1/messages/1').not_to route_to('v1/messages#destroy', id: '1')
    end
  end
end
